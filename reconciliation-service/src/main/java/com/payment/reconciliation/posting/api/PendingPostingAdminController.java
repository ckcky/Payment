...
import com.payment.reconciliation.posting.domain.PendingPostingRepository;
 ...
 *
 * <p>路径对齐 spec §9.1 {{@code /internal/{service}/pending-postings}} 模板（reconciliation 落点，前缀随既有 {{@code /internal/reconciliation}} 收敛）。</p>
 *
 ...
 */
@RestController
@RequestMapping("/internal/reconciliation/pending-postings")
