 ...
 */
public record CreateOrderResult(Long orderId, String orderNo, Long transactionId, String transactionNo,
                                OrderStatus status, long totalMinor, String currencyCode, Long paymentId,
                                String paymentStatus, String payUrl) {

    /** 兼容构造（无收银台路径）：payUrl 为 null。 */
    public CreateOrderResult(Long orderId, String orderNo, Long transactionId, String transactionNo,
                             OrderStatus status, long totalMinor, String currencyCode, Long paymentId,
