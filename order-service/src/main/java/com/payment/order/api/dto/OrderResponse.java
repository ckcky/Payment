 ...
 * 订单详情响应。
 */
public record OrderResponse(Long id, String userId, String merchantId, String status,
    ...
    public static OrderResponse from(Order order) {
        ...
        return new OrderResponse(order.getId(), order.getUserId(), order.getMerchantId(),
