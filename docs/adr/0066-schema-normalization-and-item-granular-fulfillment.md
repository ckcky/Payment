...
- 关联：ADR-0062（业务单号两字母前缀+雪花）、ADR-0063（跨服务按业务单号关联）、ADR-0064（一交易多支付单）、ADR-0054（支付编排职责归位）、spec 016（payment_attempts/attempt_type 现状）、spec 018（[spec](../specs/stage-03-evolution-consolidation/018-schema-normalization-item-fulfillment/spec.md) / [plan](../specs/stage-03-evolution-consolidation/018-schema-normalization-item-fulfillment/plan.md)）
