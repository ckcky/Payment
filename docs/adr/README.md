...
| [0025](0025-order-payment-orchestration.md) | 支付编排职责归位（ADR-0054） | **Proposed** | spec 016；Supersedes ADR-0064 §决策#4（自动退款归属） |
...
| [0054](0025-order-payment-orchestration.md#adr-0054) | 支付编排职责归位：order 升为业务编排者 / payment 退回能力提供方；自动退款决策与发起归属 order transaction 层（transactionNo + paymentNo）；Supersedes ADR-0064 §决策#4（2026-09-06） | 0025 |
