...
| 新增 Spec | `docs/specs/stage-04-new-directions/030-channel-contract-dye-alipay-sandbox/`（本文档 + plan / tasks / acceptance） | 本轮定稿 |
...
| **顺带修** | `docs/specs/stage-04-new-directions/028-channel-routing/tasks.md` 首行标题误写「026」 | 本轮修正 |
