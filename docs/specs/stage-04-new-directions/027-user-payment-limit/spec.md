...
| C2 | 全仓无 limit / quota 概念；`RiskCheckService` 与 `payment.risk.*` 已删 | ADR-0028；`docs/specs/stage-01-core-mvp/009-risk-security/spec.md` §2 | 全新子域，无历史包袱；但**必须显式切割**以免被误认为翻案 |
