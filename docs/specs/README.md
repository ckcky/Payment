...
> ⚠️ **状态说明**：`031` 编号与范围已由负责人 2026-09-21 裁决（见 spec 031 §0.2）；**`031` / `033` / `032` 已实现（2026-09-21，ADR 均 🟢 Accepted）**；**`034` / `035` 仍为「设计完成、待评审」，均未实现，其 ADR 为 🟡 Proposed，未 Accepted 前不得进入 plan/implement**；**其余 Feature 仍为提案**。
