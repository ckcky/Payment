...
**Status**: ✅ Implemented（2026-09-06 负责人拍板全部决策点，见 [ADR-0065](../../adr/0026-accounting-audit-suspense-adjustment.md)；**2026-09-07 已实现并合并 master（63f73d1），450 测试全绿，live 冒烟闭环通过**）
