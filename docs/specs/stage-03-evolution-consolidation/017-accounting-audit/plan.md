...
**最关键的一条**：`docs/specs/stage-01-core-mvp/004-ledger/spec.md:117` 的 **SC-005** 白纸黑字写着——
...
| 文件 | 状态 | 说明 |
|---|---|---|
| `docs/specs/stage-03-evolution-consolidation/017-accounting-audit/spec.md` | ✅ v0.1 Draft | **权威**：US1~US8 / FR-001~025 / NFR-001~008 / SC-001~018 |
| `docs/specs/stage-03-evolution-consolidation/017-accounting-audit/plan.md` | ✅ v0.2 Draft | 技术方案：口径、架构、数据模型、挂账调账、测试策略、模拟数据、控制台设计 |
| `docs/specs/stage-03-evolution-consolidation/017-accounting-audit/tasks.md` | ✅ v0.1 | 任务分解（批次 A~J，含依赖图） |
| `docs/specs/stage-03-evolution-consolidation/017-accounting-audit/acceptance.md` | ✅ v0.1 | 四层验收、TC 用例矩阵、E2E 断言、演示页冒烟、DoD |
| `docs/specs/stage-03-evolution-consolidation/017-accounting-audit/audit-console-mockup.html` | ✅ 原型 | 离线可点：触发 → 执行 → 差异 → 挂账 → 调账 → 复核 → 关闭；LIVE 模式按 §10.3 契约预留 |
