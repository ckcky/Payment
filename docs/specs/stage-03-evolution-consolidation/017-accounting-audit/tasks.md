...
- [x] **T008** 拍板 [plan.md §11](plan.md#11-决策裁决记录2026-09-06-负责人拍板) 六个决策点（放哪做 / 账实双轨 / 结算门禁 / P0 是否并入 / SUSPENSE 科目 / 双人复核）
...
- [x] **T082** `docs/specs/stage-01-core-mvp/004-ledger/spec.md` SC-005 标注：已加「⚠️ 从未实现（reconciliation 对 ledger 零引用）→ 由 spec 017 A1 兑现」；**017 落地后需回填为「已兑现」**
