...
- **被本 Spec 部分取代**：`docs/specs/stage-03-evolution-consolidation/020-demo-ui-design-system/spec.md`（D1 / FR-002 / FR-006 / FR-008）
- 行为不变基线：`docs/specs/stage-03-evolution-consolidation/015-multi-channel-payment/`（收银台换渠道）、`docs/specs/stage-03-evolution-consolidation/017-accounting-audit/`（审计控制台功能）、`docs/specs/stage-03-evolution-consolidation/019-order-driven-refund/`（退款双号）
