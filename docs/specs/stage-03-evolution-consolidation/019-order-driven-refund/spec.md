...
> **Status**: Implemented — 2026-09-07 负责人逐项拍板 8 项决策（见 [ADR-0067](../../../adr/0067-order-driven-refund-two-layer-refund-order.md)）；代码已实施（批次 A~D），任务见 [tasks.md](tasks.md) <!-- Draft | In Review | Approved | In Development | Implemented | Deprecated | Superseded | Not Implemented -->
