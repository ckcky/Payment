...
class DyeNotAffectingRoutingTest {
    ...
    private static PaymentChannel stub(String code) {
        return new PaymentChannel() {
            ...
            @Override
            public com.payment.channelgateway.application.ChannelResult charge(
                    com.payment.channelgateway.application.ChargeRequest request) {
                throw new UnsupportedOperationException("routing tests never call the channel");
            }

            @Override
            public com.payment.channelgateway.application.ChannelResult refund(
                    com.payment.channelgateway.application.RefundRequest request) {
                throw new UnsupportedOperationException("routing tests never call the channel");
            }

            @Override
            public com.payment.channelgateway.application.ChannelResult queryStatus(
                    com.payment.channelgateway.application.QueryStatusRequest request) {
                throw new UnsupportedOperationException("routing tests never call the channel");
            }
        };
    }
